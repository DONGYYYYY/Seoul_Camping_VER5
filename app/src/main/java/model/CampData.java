...
public class CampData implements Serializable {
    ...
    public CampData(String id,String name, String add, String tel, String value1, String value2, String value3, String homepageurl, String resurl, double x, double y) {
        this.id = id;
        this.name = name;
        this.add = add;
        this.tel = tel;
